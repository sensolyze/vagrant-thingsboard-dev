...
# # install nodejs
# sudo /vagrant/files/apps/nodejs/install-nodejs.sh
#
# # install angular/cli
# sudo /vagrant/files/apps/angular/install-angular.sh
#
# install oracle-jdk
sudo /vagrant/files/apps/oracle-jdk/install-jdk8.sh
# sudo /vagrant/files/apps/oracle-jdk/install-jdk9.sh

# # install atom
# sudo /vagrant/files/apps/atom/install-atom.sh
#
# # install visual code
# sudo /vagrant/files/apps/visualcode/install-visualcode.sh
#
# # install postman
# sudo /vagrant/files/apps/postman/install-postman.sh
#
# install vault
# sudo /vagrant/files/apps/vault/install-vault.sh
